...
- Antenati portal (Ascoli Piceno archive): search digitised civil registers for San Benedetto del Tronto / Ascoli Piceno — could find 1930 Remo×Irma marriage act or Irma Pirri birth record for free, in parallel with the SBT anagrafe request (Rosa De Falco) already in flight. **UPDATE 11 Aug 2026: Antenati Ascoli Piceno archive has NO "Matrimoni" (marriage) registers published — only Censimento (201 items, 1800-1880) and 4 Morti allegati (1915/1919). SBT has no dedicated Antenati archive. Antenati route closed for Alfredo×Ida marriage tiebreaker AND for Remo×Irma 1930 marriage. The pending comune requests (prot. 0062771 for Alfredo×Ida, and Rosa De Falco SBT anagrafe for Remo×Irma) remain the operative channels.**
- NAA RecordSearch: Ezio bankruptcy case file (No. 248 of 1957, Broadford VIC café/milk bar) — full financial schedules/affidavits at NAA (not just the Gazette notice); browser-doable, free. **UPDATE 11 Aug 2026: surname + case-number searches (B9, 248/1957, "Buatti bankruptcy") all returned no hits — file likely indexed by registry/case number only and not surname-searchable on RecordSearch. Trove Gazette notice remains the surviving public record. Possible route: ask NAA directly via Contact Us form to locate file 248/1957 in the VIC registry series.**
